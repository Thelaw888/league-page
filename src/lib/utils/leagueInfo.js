/*   STEP 1   */
export const leagueID = "012978"; // your league ID
export const leagueName = "Top Dawgz"; // your league name
...
export const managers = [
    {
      ...
      "location": "Mission Hills", // (optional)
      "bio": "Piasa...",
